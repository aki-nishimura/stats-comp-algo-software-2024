...
I wrote a new script in the `src/` folder called `safe_axpy_c.cpp` and tested it in the chunk below.

```{r my-axpy, eval=FALSE}
Rcpp::sourceCpp(file.path("src", "safe_axpy_c.cpp"), rebuild = TRUE)
