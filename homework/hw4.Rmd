...
Cholesky decomposition is fastest (median time: 172 ms), followed by LU decomposition (median time: 175 ms), and then QR decomposition (median time: 518 ms).
