...
Both the l2-norm relative difference and the coordinate-wise relative difference show that the method from most to least accurate are : **Cholesky, LU, QR**. The trend is consistent over all x values.
