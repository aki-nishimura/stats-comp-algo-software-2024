...
- Hyperlink to the `hiperglm` repository on your Github account: https://github.com/m-qin/hiperglm
- Screenshot of the package's Git history visualized through a Git GUI of your choice:

<img src="figure/git_history_screenshot.png" alt="Screenshot from GitHub Desktop"/>
