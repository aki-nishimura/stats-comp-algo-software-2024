...
Turns out to be a normal distribution. This is due to central limit theorem since the random variable (sample_sec_mom) is the sum of many iid random variables and the sum should approaching a normal distribution, and (sample_mean) ^ 2 has really small variance thus almost constant. Thus the difference between them is approximately a normal distribution.
...
[Link to the pull request](https://github.com/thepianistalex/hiperglm/pull/2).
