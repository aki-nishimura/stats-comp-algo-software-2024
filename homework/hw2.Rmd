...
# Exercise 2: Numerical differentiation & potential caveats
...
6. Implement the MLE finder via BFGS:
    ...
    Along the way, you should implement a helper function to approximate the gradient of a given function via finite difference.
