...
The distribution of the estimator `sample_var_with_question_mark` under repeated Monte Carlo simulations is normal distribution by central limit theorem?
...
*Answer*: Yes the relative error plot agrees with the mathematical theory. log relative error is $log_2(\Delta x^2) = 2 log_2(\Delta x)$, and the plot agrees that there is a linear relationship between log2 step size and log2 relative error.

The slope in the latter part of the plotted line is roughly 1, and which is increasing and is much less smooth than the earlier part. 
