...
Remember to commit your work on the `develop` branch.
Then open a pull request into your main branch after completing the assignment and request a review from the TA.
...
Even if you want to try implementing the more general case, you might consider starting with the binary case and extending it after completing Step 7.
