...
* Link to the pull request: https://github.com/yanxiliu230/hiperglm/pull/5
* (Optional) Answer to the bonus question.

No. Ideally the convergence tolerance would be small. However due to finite precision, the current log likelihood and previous might never get close enough to pass the convergence criterion.
