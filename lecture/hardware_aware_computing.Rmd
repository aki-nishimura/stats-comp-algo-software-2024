...
cpp_file_list <- c('axpy_c.cpp', 'axpy_c_alt.cpp', 'axpy_eigen.cpp', 'axpy_eigen_mapped.cpp', 'gemm_eigen.cpp', 'gemm_arma.cpp', 'sign.cpp', 'matvec.cpp')

for (cpp_file in cpp_file_list) {
  sourceCpp(file.path('src', cpp_file))
}
```
